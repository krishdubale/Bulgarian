...
class _FlashcardScreenState extends ConsumerState<FlashcardScreen>
  ...
  late List<BulgarianWord> _words;
  int _currentIndex = 0;
  ...
  void initState() {
    super.initState();
    _words = BulgarianData.vocabulary
  ...
  void _markLearned() {
    ref.read(userProgressProvider.notifier).incrementWords(1);
    _next();
    setState(() => _learned++);
  }
